...
onload = function () {
    ...
    function createData(){
        ...
        // Dynamically creating edges with random amount to be paid from one friend to another friend
        const edges = [];
        for(let i=1;i<=sz;i++){
    ...
    function solveData() {
        ...
        const pos_heap = new BinaryHeap();//for the friend who is in credit position
        const neg_heap = new BinaryHeap();//for the friend who is in debit position
